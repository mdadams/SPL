...
set build_dir_static=c:\tmp\SPL\build\static
set install_dir_shared=c:\tmp\SPL\install\shared
set install_dir_static=c:\tmp\SPL\install\static
...
dir %install_dir_static%\include\SPL || exit /B 1
...
dir %install_dir_shared%\include\SPL || exit /B 1
