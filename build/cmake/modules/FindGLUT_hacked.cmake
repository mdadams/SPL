...
if (GLUT_FOUND)
	...
	check_include_files(GL/glut.h SPLEL_HAVE_GL_GLUT_H)
	check_include_files(glut.h SPLEL_HAVE_GLUT_H)
	message("SPLEL_HAVE_GLUT_H: ${SPLEL_HAVE_GLUT_H}")
	message("SPLEL_HAVE_GL_GLUT_H: ${SPLEL_HAVE_GL_GLUT_H}")
	if (SPLEL_HAVE_GL_GLUT_H OR SPLEL_HAVE_GLUT_H)
		set(GLUT_FOUND true)
